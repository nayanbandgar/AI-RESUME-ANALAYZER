      ...
      <div className="bg-black-100  border-white border-4 rounded-2xl p-10 w-full max-w-md text-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full py-2.5 bg-white text-gray-900 text-l font-medium rounded-lg border border-gray-200 hover:border-white  hover:bg-950  hover:text-white  transition-colors hover:scale-105 duration-200  cursor-pointer"
          >
            Sign Up
          </button>
        </div>
