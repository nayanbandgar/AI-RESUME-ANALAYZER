...
//             className="bg-white text-red-950 px-4 py-2 rounded-lg hover:bg-red-200 transition"
//           >
//             Logout
//           </button>
...
//       <div
//         key={index}
//         className="flex items-center justify-between p-4 mb-3  rounded-xl hover:shadow-md hover:bg-red-200 transition"
//       >
//         <div className="flex items-center gap-4">
